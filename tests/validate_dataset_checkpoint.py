...
metadata_json_list = [
    "C:/Users/wise-temp-1/AudioLDM-training-finetuning/data/dataset/metadata/audiocaps/datafiles/audiocaps_train_label.json",
    "C:/Users/wise-temp-1/AudioLDM-training-finetuning/data/dataset/metadata/audiocaps/testset_subset/audiocaps_test_nonrepeat_subset_0.json",
]
missing_files_count = 0
for metadata_json in metadata_json_list:
    metadata = load_json(metadata_json)["data"]
    for datapoint in tqdm(metadata):
        audiopath = os.path.join("C:/Users/wise-temp-1/AudioLDM-training-finetuning/data/dataset/audioset", datapoint["wav"])
